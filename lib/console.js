"use strict";
var tinytim = require('tinytim'), dateFormat = require('dateformat'), utils = require('./utils'), path = require('path'), settings = require('./settings').settings, fs = require('fs');
...
module.exports = (function() {
	...
	if(typeof userConfig[0] === 'string') {
		if(!fs.existsSync(userConfig[0])) throw (new Error('Config File not found!'));
		userConfig = JSON.parse(fs.readFileSync(userConfig[0], 'utf8'));
	}
